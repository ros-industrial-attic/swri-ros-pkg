...
namespace longhorn_manipulator_kinematics
{

//autogenerated file
#include "longhorn_manipulator_ikfast_output.cpp"
...
PLUGINLIB_DECLARE_CLASS(longhorn_manipulator_kinematics, IKFastKinematicsPlugin, longhorn_manipulator_kinematics::IKFastKinematicsPlugin, kinematics::KinematicsBase);
