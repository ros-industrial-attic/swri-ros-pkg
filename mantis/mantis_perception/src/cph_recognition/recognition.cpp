...
////////////////////Assign marker and response properties
  ...
  else if (label.substr(found+1)=="pvc_t_1" || label.substr(found+1)=="pvct" || label.substr(found+1)=="pvct_a_1"|| label.substr(found+1)=="pvct_a_2"|| label.substr(found+1)=="pvct_a_3")
  {
