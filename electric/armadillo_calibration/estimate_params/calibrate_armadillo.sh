...
roslaunch armadillo_calibration estimation_config.launch
rosrun calibration_estimation multi_step_cov_estimator.py /tmp/armadillo_calibration/cal_measurements.bag /tmp/armadillo_calibration __name:=cal_cov_estimator
...
chmod ag+w /tmp/armadillo_calibration/*
