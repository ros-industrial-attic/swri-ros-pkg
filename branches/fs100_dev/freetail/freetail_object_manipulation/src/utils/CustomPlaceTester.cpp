...
CustomPlaceTester::CustomPlaceTester()
{

}

CustomPlaceTester::CustomPlaceTester(planning_environment::CollisionModels* cm,
...
void CustomPlaceTester::setTcpToWristTransform(const tf::Transform &tcpTransform)
{
	_TcpToWristTransform = tcpTransform;
}

void CustomPlaceTester::testPlaces(const object_manipulation_msgs::PlaceGoal &place_goal,
